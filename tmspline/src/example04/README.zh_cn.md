...
### 该示例实现将删除面留下的边向四周拉伸从而生成新的顶面。具体实现如下：
...
## 7. 保存网格
	...
	3. 使用 TMSplineMeshingIO 下的 ExportToOBJ 将网格化结果导出为 part4 的 OBJ 文件
	
<div align = center><img src="https://s2.loli.net/2024/09/30/I96AkMvtZYSzf57.png" width="300" height="300">
